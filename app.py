...
app = Flask(__name__)
app.secret_key = 'super-secret-key'  # Puoi mantenerlo o rimuoverlo se non usi sessioni
...
def index():
    if request.method == 'POST':
        ...
        # Confronta i valori: per ogni valore in df1, cerca corrispondenze nella colonna di df2
        rows = []
